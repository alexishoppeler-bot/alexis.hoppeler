...
(function initExerciseConfig() {
  ...
  const entries = [
    ...
    { page: 'maths-pratiques', name: 'Maths pratiques',       icon: '🧮', cat: 'Compétences',   section: 'Communication',      themes: ['numérique', 'emploi', 'transports', 'orp'] },
    ...
    { page: 'anagramme',   name: 'Anagramme',                 icon: '🔀', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'orp', 'transports'] },
    { page: 'apparier',    name: 'Apparier',                  icon: '🔗', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'orp', 'transports'] },
    { page: 'pendu',       name: 'Pendu',                     icon: '🪢', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'orp', 'transports', 'santé'] },
    { page: 'vrai-faux',   name: 'Vrai / Faux',               icon: '✅', cat: 'Jeu',           section: 'Communication',      themes: ['emploi', 'orp', 'numérique', 'transports'] },
    { page: 'classement',  name: 'Classement',                icon: '📊', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'orp', 'transports', 'santé', 'logement'] },
    { page: 'mots-croises',name: 'Mots croisés',              icon: '🧱', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'transports'] },
    { page: 'mots-meles',  name: 'Mots mêlés',                icon: '🔠', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'transports'] },
    { page: 'demeler',     name: 'Démêler',                   icon: '🧶', cat: 'Jeu',           section: 'Communication',      themes: ['numérique', 'emploi', 'orp', 'transports'] },
